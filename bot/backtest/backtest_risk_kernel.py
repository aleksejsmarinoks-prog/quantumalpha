...
Migrated: 2026-05-18 — bot/backtester/ → bot/backtest/ (Step 4 consolidation)

This file is a verbatim copy of the production-deployed source from
commit f54c562 (Step 3). Only the docstring header is annotated to note
the path migration. NO behavioral changes.
...
# ---------------------------------------------------------------------------
# Clock protocol (for mypy — WallClock + BacktestClock implement this)
# ---------------------------------------------------------------------------
...
class BacktestRiskKernel:
    ...
    def __init__(
        ...
        self.clock: ClockProtocol = clock or WallClock()
